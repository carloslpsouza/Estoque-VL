...
Route::get('/movimentos/detalhe/{tipo?}/{id?}', [MovimentoController::class, 'show'])->middleware('auth');
...
Route::get('/setorName/{id?}', [SetorController::class, 'showName'])->middleware('auth');
